...
export default function NuevaPeliculaPage() {
  ...
  // Cargar géneros y países al montar el componente
  useEffect(() => {
    const cargarDatos = async () => {
      try {
        const [generosRes, paisesRes] = await Promise.all([
          fetch('/api/generos'),
          fetch('/api/paises')
        ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("=== DEBUG FRONTEND: Enviando datos ===", formData);
      console.log("=== DEBUG FRONTEND: URLs específicas ===", {
      ...
      if (response.ok) {
        ...
        setError(data.error || "Error al crear la película");
      }
    } catch (err) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-green-500/20 border border-green-500/50 rounded-xl p-8">
            ...
            <h2 className="text-2xl font-bold text-green-300 mb-2">¡Película creada!</h2>
            <p className="text-gray-300 mb-4">
              La película ha sido agregada exitosamente al catálogo.
            </p>
            <Link 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Nueva Película</h1>
